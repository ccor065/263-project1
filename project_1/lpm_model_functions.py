...
def curve_fit_pressure(t, a, b, c): #comment done
    '''
    ...
    return pressureODE
def find_pars_pressure():#comment done
    '''
    finds the specific parameters for the ODE solver using scipy curve_fit.
...
def get_q_dq_conc(t):#comment done
    '''
...
#### numerical Solvers
def improved_euler_step(f, tk, yk, h, y0, pars): # comment done
    '''
    Computes dp/dt at a specific time given parameters
...
def solve_pressure_ode(f, t0, y0, t1, h, pars):# comment done
    '''
    Computes dp/dt at a specific time given parameters
    ...
    return  ts, ys
def solve_pressure_const_q(f, t0, y0, t1, h, pars):# comment done
    '''
...
'''
### Curve fitting functions
def curve_fit_conc(t, d, m0):#comment done
    '''
    Solve pressure ode with the given paramters
